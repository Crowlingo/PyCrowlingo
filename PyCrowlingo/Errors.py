...
class InternalError(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(500, "Internal Error, please contact an administrator if it happens again")
...
class TestModelForbidden(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(403, "You do not have access to the test version of this model. Ask the access to the owner of"
                              " the model or use the production version of this model")
...
class BadModelPerms(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(403, "You do not have the permissions to perform this action on this model. "
                              "Ask the owner of this model to get permission.")
...
class BadModelCategory(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(404, "This model cannot be use for this kind of request. "
                              "Create a new model or use another endpoint.")


class ModelNotDeployed(CrowlingoException):

    def __init__(self):
        super().__init__(404, "This model is not deployed. Use the test model or deploy it first.")
...
class TokenNotFound(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(401, "Token not found. Insert your token in the query parameter by "
                              "api_key=[YOUR_TOKEN]  or in the headers by x-api-key:[YOUR TOKEN].")


class CollaboratorNotFound(CrowlingoException):

    def __init__(self):
        super().__init__(404, "This collaborator was not found.")


class ModelNotFound(CrowlingoException):

    def __init__(self):
        super().__init__(404, "Model not Found. You have to create a model before using it.")


class DocumentNotFound(CrowlingoException):

    def __init__(self):
        super().__init__(404, "Document not Found. You have to create a document before using it.")
...
class MinuteLimitReached(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(429, "Minute limit reached, wait the number of seconds indicated by "
                              "the header: x-minute-reset or upgrade your subscription plan.")
...
class PeriodLimitReached(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(429, "Period limit reached, wait the number of seconds indicated by "
                              "the header: x-period-reset or upgrade your subscription plan.")


class ModelsLimitReached(CrowlingoException):

    def __init__(self):
        super().__init__(429, "You have reached the maximal number of custom models allowed. If you want to create a new one, "
                              "you have to delete one of your custom models first or upgrade your subscription plan.")
...
class SubscriptionNotFound(CrowlingoException):
    ...
    def __init__(self):
        super().__init__(404, "No subscription was found for this kind of plan. "
                              "Modify user's custom parameters for a custom plan.")


class DuplicateEmail(CrowlingoException):

    def __init__(self):
        super().__init__(409, "This email is already in use ")
