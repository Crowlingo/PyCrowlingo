...
class Faq(Connector):
    ...
    def update_question(self, model_id, question_id, answer_id=None, translations=None):
        return Models.UpdateQuestion.fill(**locals()).call(self.client)

    def update_answer(self, model_id, answer_id, translations=None):
    ...
    def list_questions(self, model_id, page=None, page_size=None, lang=None, id=None, answer_id=None):
        return Models.ListQuestions.fill(**locals()).call(self.client)

    def list_answers(self, model_id, page=None, page_size=None, id=None):
