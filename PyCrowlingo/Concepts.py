...
class Concepts(Connector):
    ...
    def list_concepts(self, model_id, page=None, page_size=None, id=None):
        return Models.ListConcepts.fill(**locals()).call(self.client)

    def list_labels(self, model_id, page=None, page_size=None, id=None, text=None, lang=None, concept_id=None):
